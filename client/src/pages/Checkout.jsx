      ...
      <div className="max-w-2xl w-full space-y-8">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          ...
          <ul className="divide-y divide-gray-200">
            {cart.map((item, index) => (
              <li key={index} className="flex flex-col md:flex-row justify-between items-center py-4">
                <div className="flex w-full items-center md:items-start flex-1 space-y-2 md:space-y-0 md:text-left">
                  <span className="text-m flex-1 text-gray-800">
                    {item.title}
                  </span>
                ...
                <div className="flex justify-between items-center w-full md:w-auto mt-4 md:mt-0 space-x-4">
                  ...
                  <button onClick={() => removeFromCart(item.id)} className="bg-red-500 hover:bg-red-600 text-white py-1 px-3 rounded-full">
                    Remove
                  </button>
                </div>
              </li>
        ...
        <div className="text-center">
          <button onClick={handlePlaceOrder} className="place-order-btn text-white font-semibold py-2 px-4 rounded-full mb-4 w-full">
            Place Order
          </button>

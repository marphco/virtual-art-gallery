      ...
      <div className="welcome">
        <div className="text">
          ...
          <p>
            ...
            central hallway, it offers seamless navigation through an exquisite
            collection of artworks. Each corner of The Art Haven holds treasures
            waiting to be discovered, inviting visitors to immerse themselves in
